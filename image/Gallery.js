define([
	...
	return declare("dojox.image.Gallery",
		...
		toggleSlideshow: function(){
			kernel.deprecated("dojox/widget/Gallery#toggleSlideshow is deprecated.  Use toggleSlideShow instead.", "", "2.0");
		...
		_centerChildren: function() {
			...
			//		are centered.
			var thumbSize = domGeometry.getMarginBox(this.thumbPicker.outerNode);
			var slideSize = domGeometry.getMarginBox(this.slideShow.outerNode);
